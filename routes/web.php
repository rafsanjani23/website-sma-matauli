...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware('admin.auth')->group(function () {
        ...
        // Dashboard — accessible to all authenticated admins (filtered by role inside controller)
        Route::get('/', [DashboardController::class, 'index'])->name('admin.dashboard');

        // ============================================================
        // SUPER ADMIN ONLY — Kelola admin lain
        // ============================================================
        ...
        // ============================================================
        // SEKOLAH — super_admin & admin_sekolah (semua panel KECUALI asrama)
        // ============================================================
        Route::middleware('admin.role:super_admin,admin_sekolah')->group(function () {
        ...
        // ============================================================
        // ASRAMA — super_admin & admin_asrama
        // ============================================================
        Route::middleware('admin.role:super_admin,admin_asrama')->group(function () {
