...
use App\Models\BerandaProgramIb;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class BerandaProgramIbController extends Controller
{
    ...
    {
        return view('admin.beranda.program-ib.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('foto')) {
            $validated['foto'] = $request->file('foto')->store('beranda/program-ib', 'public');
        }

        BerandaProgramIb::create($validated);

        return redirect()->route('admin.beranda.program-ib.index')->with('success', 'Data berhasil ditambahkan.');
    }

    public function edit($id)
    {
        $item = BerandaProgramIb::findOrFail($id);
        return view('admin.beranda.program-ib.edit', compact('item'));
    }
