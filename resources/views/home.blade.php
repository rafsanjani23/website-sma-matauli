...
<body>
    ...
    <footer class="bg-matauli-red-dark text-white">
        {{-- <!-- Blue Top Border -->
        <div class="h-1 bg-linear-to-r from-blue-600 via-blue-400 to-blue-600"></div> --}}
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div class="flex flex-col items-start space-y-6">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <!-- Vertical Divider -->
                        <div class="h-32 w-0.5 bg-yellow-500"></div>

                        <!-- School Name -->
                        <div class="flex flex-col">
                            <h2 class="text-3xl font-bold tracking-wider leading-tight">
                                SMAN 1<br>
                                MATAULI<br>
                                PANDAN
                            </h2>
                    ...
                    <!-- Copyright -->
                    <div class="text-sm text-gray-300 mt-8">
                        <p>Copyright 2026. All right reserved.</p>
                        <p class="font-semibold">SMAN 1 Matauli Pandan</p>
                    </div>
                </div>

                <!-- ========== COLUMN 2: Kunjungi Kami ========== -->
                <div>
                    <h3 class="text-xl font-bold mb-4 pb-2 border-b-2 border-yellow-500 inline-block">
                        Kunjungi Kami
                    </h3>
                    ...
                    <div class="mt-6 space-y-4">
                        ...
                        <div class="flex items-start gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-yellow-500 shrink-0 mt-1"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="tel:+628888888888" class="text-gray-200 hover:text-yellow-500 transition">
                                +62 888-8888-8888
                            </a>
                        </div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="mailto:examplematauli@gmail.com"
                                class="text-gray-200 hover:text-yellow-500 transition">
                    ...
                    <ul class="mt-6 space-y-3">
                        <li>
                            <a href="{{ url('/tentang-kami') }}"
                                class="text-gray-200 hover:text-yellow-500 transition hover:translate-x-1 inline-block">
                                Tentang Kami
                            </a>
                        </li>
                        <li>
                ...
                <div>
                    ...
                    <div class="mt-6 flex gap-4">
                        ...
                        <a href="https://facebook.com" target="_blank"
                            class="bg-white/10 hover:bg-yellow-500 p-3 rounded-full transition-all hover:scale-110">
