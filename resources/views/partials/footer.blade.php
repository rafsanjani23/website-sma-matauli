            ...
            <div class="flex flex-col">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center gap-3 pt-1">
                        ...
                        <span
                            class="text-[10px] text-yellow-400/70 font-bold tracking-widest uppercase shrink-0">{{ __('Asrama') }}</span>
                        <div class="flex-1 h-px bg-white/10"></div>
                    </div>

                    <!-- Contact Person Asrama -->
                    <div class="flex items-center gap-3 group hover:translate-x-1 transition-transform duration-300">
                        <div
                            class="shrink-0 w-10 h-10 rounded-lg bg-white/10 backdrop-blur-sm flex items-center justify-center group-hover:bg-yellow-400 transition-colors duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="flex-1">
                            <p class="text-xs text-yellow-400 font-semibold mb-1">{{ __('CP Asrama') }}</p>
                    ...
                    <div class="flex items-center gap-3 group hover:translate-x-1 transition-transform duration-300">
                        ...
                        <div class="flex-1">
                            <p class="text-xs text-yellow-400 font-semibold mb-1">{{ __('Email Asrama') }}</p>
