            ...
            @forelse ($items as $item)
                <div class="border border-gray-300 border-b-2 rounded-md overflow-hidden">
                    <div class="w-full aspect-3/2 bg-gray-50">
                        @if ($item->foto)
                            <img src="{{ Storage::url($item->foto) }}" class="w-full h-full object-fill" alt="{{ $item->nama }}" />
                        @else
                    ...
                    <div class="p-4">
                        ...
                        <div class="space-x-4 mt-4">
                            ...
                            <a href="{{ $item->link_linkedin }}" target="_blank"
                                class="w-7 h-7 inline-flex items-center justify-center rounded-full bg-[#0077b5] hover:bg-[#0055b5]">
