    ...
    <div class="mb-20 mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-2 px-40 mt-10 max-w-5xl mx-auto">
            ...
            <div class="text-center">
                <a href="https://instagram.com/namasekolah" target="_blank"
            ...
            <!-- Facebook -->
            <div class="text-center">
                <a href="https://facebook.com/namasekolah" target="_blank"
                    class="w-25 h-25 flex items-center justify-center rounded-full text-white text-2xl mx-auto hover:scale-110 transition duration-300">
                    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
            ...
            <!-- YouTube -->
            <div class="text-center">
                <a href="https://youtube.com/@namasekolah" target="_blank"
                    ...
                    <svg viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
