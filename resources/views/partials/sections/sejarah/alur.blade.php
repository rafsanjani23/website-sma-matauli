    ...
    <div class="container mx-auto px-4 sm:px-6 md:px-12 lg:px-24 xl:px-32">
        ...
        <div class="relative max-w-6xl mx-auto">
            ...
            <div class="md:hidden space-y-0">
                ...
                {{-- ── HELPER MACRO: setiap item mobile ── --}}
                {{-- Struktur: dot + garis kiri | card kanan --}}
                ...
                <div class="flex gap-4">
                    <div class="flex flex-col items-center shrink-0 w-12">
                        ...
                        <div class="w-0.5 flex-1 bg-linear-to-b from-red-800 to-red-700 mt-1"></div>
                    </div>
                    <div class="flex-1 pt-1 pb-6">
                        <div class="bg-white rounded-2xl shadow-md border-l-4 border-red-800 overflow-hidden">
                            <div class="h-44 w-full overflow-hidden">
                                <img src="{{ asset('assets/sejarah/Sejarah_1991.webp') }}" alt="1991"
                ...
                <div class="flex gap-4">
                    <div class="flex flex-col items-center shrink-0 w-12">
                        ...
                        <div class="w-0.5 flex-1 bg-linear-to-b from-red-700 to-red-600 mt-1"></div>
                    </div>
                    <div class="flex-1 pt-1 pb-6">
                        <div class="bg-white rounded-2xl shadow-md border-l-4 border-red-800 overflow-hidden">
                            <div class="h-44 w-full overflow-hidden">
                                <img src="{{ asset('assets/sejarah/Sejarah_1994.webp') }}" alt="1994"
                                    class="w-full h-full object-cover">
                            </div>
                            <div class="p-5">
                                <h3 class="text-base font-bold text-grey-900 mb-2 leading-snug">
                ...
                <div class="flex gap-4">
                    <div class="flex flex-col items-center shrink-0 w-12">
                        ...
                        <div class="w-0.5 flex-1 bg-linear-to-b from-red-600 to-red-500 mt-1"></div>
                    </div>
                    <div class="flex-1 pt-1 pb-6">
                        <div class="bg-white rounded-2xl shadow-md border-l-4 border-red-800 overflow-hidden">
                            <div class="h-44 w-full overflow-hidden">
                                <img src="{{ asset('assets/sejarah/Sejarah_1994_2.webp') }}" alt="1994 Kerjasama"
                                    class="w-full h-full object-cover">
                            </div>
                            <div class="p-5">
                                <h3 class="text-base font-bold text-grey-900 mb-2 leading-snug">
                ...
                <div class="flex gap-4">
                    <div class="flex flex-col items-center shrink-0 w-12">
                        ...
                        <div class="w-0.5 flex-1 bg-linear-to-b from-red-500 to-red-400 mt-1"></div>
                    </div>
                    <div class="flex-1 pt-1 pb-6">
                        <div class="bg-white rounded-2xl shadow-md border-l-4 border-red-800 overflow-hidden">
                            <div class="h-44 w-full overflow-hidden">
                                <img src="{{ asset('assets/sejarah/Sejarah_1995.webp') }}" alt="1995"
                                    class="w-full h-full object-cover">
                            </div>
                            <div class="p-5">
                                <h3 class="text-base font-bold text-grey-900 mb-2 leading-snug">
                ...
                <div class="flex gap-4">
                    <div class="flex flex-col items-center shrink-0 w-12">
                        ...
                        <div class="w-0.5 flex-1 bg-linear-to-b from-red-400 to-red-300 mt-1"></div>
                    </div>
                    <div class="flex-1 pt-1 pb-6">
                        <div class="bg-white rounded-2xl shadow-md border-l-4 border-red-800 overflow-hidden">
                            <div class="h-44 w-full overflow-hidden">
                                <img src="{{ asset('assets/sejarah/Sejarah_2004.webp') }}" alt="2004"
                                    class="w-full h-full object-cover">
                            </div>
                            <div class="p-5">
                                <h3 class="text-base font-bold text-grey-900 mb-2 leading-snug">
                ...
                <div class="flex gap-4">
                    <div class="flex flex-col items-center shrink-0 w-12">
                        ...
                        <div class="w-0.5 flex-1 bg-linear-to-b from-red-300 to-yellow-600 mt-1"></div>
                    </div>
                    <div class="flex-1 pt-1 pb-6">
                        <div class="bg-white rounded-2xl shadow-md border-l-4 border-red-800 overflow-hidden">
                            <div class="h-44 w-full overflow-hidden">
                                <img src="{{ asset('assets/sejarah/Sejarah_2008.webp') }}" alt="2008"
                                    class="w-full h-full object-cover">
                            </div>
                            <div class="p-5">
                                <h3 class="text-base font-bold text-grey-900 mb-2 leading-snug">
                ...
                <div class="flex gap-4">
                    <div class="flex flex-col items-center shrink-0 w-12">
                        ...
                        <div class="w-0.5 flex-1 bg-linear-to-b from-yellow-600 to-yellow-500 mt-1"></div>
                    </div>
                    <div class="flex-1 pt-1 pb-6">
                        <div class="bg-white rounded-2xl shadow-md border-l-4 border-red-800 overflow-hidden">
                            <div class="h-44 w-full overflow-hidden">
                                <img src="{{ asset('assets/sejarah/Sejarah_2012.webp') }}" alt="2012"
                                    class="w-full h-full object-cover">
                            </div>
                            <div class="p-5">
                                <h3 class="text-base font-bold text-grey-900 mb-2 leading-snug">
                ...
                <div class="flex gap-4">
                    ...
                    <div class="flex-1 pt-1 pb-6">
                        <div class="bg-white rounded-2xl shadow-md border-l-4 border-red-800 overflow-hidden">
                            <div class="h-44 w-full overflow-hidden">
                                <img src="{{ asset('assets/sejarah/Sejarah_2014.webp') }}" alt="2014"
                                    class="w-full h-full object-cover">
                            </div>
                            <div class="p-5">
                                <h3 class="text-base font-bold text-grey-900 mb-2 leading-snug">
                ...
                {{-- ITEM 10: 2026 NOW (terakhir, tanpa garis bawah) --}}
                <div class="flex gap-4">
                    <div class="flex flex-col items-center shrink-0 w-12">
                        <div
                    ...
                    <div class="flex-1 pt-1 pb-6">
                        <div
                            ...
                            <div class="h-44 w-full overflow-hidden">
                                <img src="{{ asset('assets/sejarah/Sejarah_2026.webp') }}" alt="2026"
                                    class="w-full h-full object-cover">
                            </div>
                            <div class="p-5">
            ...
            <div class="hidden md:block space-y-0">
                ...
                {{-- ITEM 3: 1994 Kerjasama - teks kiri | foto kanan --}}
                <div class="relative grid grid-cols-2 gap-0 min-h-64 mb-16">
                    <div class="flex items-center justify-end pr-16 py-8">
                        <div class="max-w-sm w-full">
                            <div
                    ...
                    <div class="flex items-center justify-start pl-16 py-8">
                        <div class="max-w-sm w-full h-56 rounded-2xl overflow-hidden shadow-xl bg-gray-100">
                            <img src="{{ asset('assets/sejarah/Sejarah_1994_2.webp') }}" alt="1994"
                                class="w-full h-full object-cover hover:scale-105 transition-transform duration-500">
                        </div>
                    </div>
                </div>

                {{-- ITEM 4: 1995 - foto kiri | teks kanan --}}
                <div class="relative grid grid-cols-2 gap-0 min-h-64 mb-16">
                    <div class="flex items-center justify-end pr-16 py-8">
                        <div class="max-w-sm w-full h-56 rounded-2xl overflow-hidden shadow-xl bg-gray-100">
                            <img src="{{ asset('assets/sejarah/Sejarah_1995.webp') }}" alt="1995"
                ...
                {{-- ITEM 5: 2004 - teks kiri | foto kanan --}}
                <div class="relative grid grid-cols-2 gap-0 min-h-64 mb-16">
                    <div class="flex items-center justify-end pr-16 py-8">
                        <div class="max-w-sm w-full">
                            <div
                ...
                {{-- ITEM 6: 2008 - foto kiri | teks kanan --}}
                <div class="relative grid grid-cols-2 gap-0 min-h-64 mb-16">
                    <div class="flex items-center justify-end pr-16 py-8">
                        <div class="max-w-sm w-full h-56 rounded-2xl overflow-hidden shadow-xl bg-gray-100">
                            <img src="{{ asset('assets/sejarah/Sejarah_2008.webp') }}" alt="2008"
                ...
                {{-- ITEM 7: 2012 - teks kiri | foto kanan --}}
                <div class="relative grid grid-cols-2 gap-0 min-h-64 mb-16">
                    <div class="flex items-center justify-end pr-16 py-8">
                        <div class="max-w-sm w-full">
                            <div
                ...
                {{-- ITEM 8: 2014 - foto kiri | teks kanan --}}
                <div class="relative grid grid-cols-2 gap-0 min-h-64 mb-16">
                    <div class="flex items-center justify-end pr-16 py-8">
                        <div class="max-w-sm w-full h-56 rounded-2xl overflow-hidden shadow-xl bg-gray-100">
                            <img src="{{ asset('assets/sejarah/Sejarah_2014.webp') }}" alt="2014"
                ...
                {{-- ITEM 10: 2026 NOW - foto kiri | teks kanan --}}
