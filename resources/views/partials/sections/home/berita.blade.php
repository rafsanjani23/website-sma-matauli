...
<section id="berita-terkini" class="py-12 md:py-16 lg:py-20 bg-[#fff9f9]">
    <div class="container mx-auto px-4 sm:px-6 md:px-12 lg:px-24 xl:px-32">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-6 md:mb-8">
            ...
            <!-- Berita Card 1 -->
            <a href="{{ route('galeri-media-detail') }}" class="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group cursor-pointer block">
                <!-- Image -->
                ...
                <div class="p-5 md:p-6">
                    <div class="flex items-center gap-2 mb-3">
                        <span class="text-xs font-semibold text-matauli-red-dark bg-red-50 px-3 py-1 rounded-full">JUDUL
                            BERITA</span>
                    </div>
