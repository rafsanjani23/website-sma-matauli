<section class="bg-white py-15">
    <div class="mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-2 px-10">
            <div>
                <div
                    class="bg-white border border-gray-200 shadow-md w-full max-w-sm rounded-4xl overflow-hidden mx-auto">
                ...
                <div class="p-2">
                    <h5 class="text-matauli-red-dark text-center text-md font-semibold"> FASILITAS ASRAMA
                    </h5>
                </div>
            </div>
            <div>
