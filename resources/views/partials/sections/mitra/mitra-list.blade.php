<section class="py-16 bg-[#fdf9f6] text-center">
  ...
  <div class="relative mt-10 max-w-4xl mx-auto">
    ...
    <div id="slider"
      ...
      <div class="snap-center shrink-0 w-[220px] md:min-w-[280px] h-32 md:h-40 border border-red-400 rounded-2xl flex items-center justify-center font-semibold bg-white">
        Mitra 2
      </div>
