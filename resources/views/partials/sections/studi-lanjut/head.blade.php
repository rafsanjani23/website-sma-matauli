    ...
    <div class="mx-auto px-4">
        <div class="text-center mb-12">
            <h1 class="mt-2 text-3xl md:text-5xl font-bold text-slate-950 mb-2 md:mb-4">
                {{ __('Studi Lanjut Alumni SMA Negeri 1 MATAULI Pandan') }}
            </h1>
            <p class="text-gray-500 text-sm md:text-lg max-w-4xl mx-auto leading-relaxed px-4">
                {{ __('Terus Bertumbuh, Terus Berdampak. Mengantarkan lulusan kami menembus gerbang perguruan tinggi impian') }}
            </p>
