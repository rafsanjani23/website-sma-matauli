    ...
    <div class="container mx-auto px-4 sm:px-6 md:px-12 lg:px-24 xl:px-32">
        ...
        <div class="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
            ...
            <div class="order-1 md:order-2 relative">
                <div
                    class="absolute -top-4 -right-4 w-full h-full rounded-2xl border-2 border-yellow-400/50 hidden md:block">
                </div>
                <div class="absolute -bottom-4 -left-4 w-24 h-24 rounded-full bg-red-800/10 hidden md:block"></div>
