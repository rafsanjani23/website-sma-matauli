    ...
    <div class="mx-auto px-4">
        <div class="p-2">
            <div class="space-y-2 mx-auto">
                ...
                {{-- ===== ACCORDION 1: Guru Mata Pelajaran ===== --}}
                <div role="accordion">
                    <button type="button"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-2 mt-3 px-6">
                            <div>
                                <div
                                    ...
                                    <div class="p-2">
                                        <h5 class="text-matauli-red-dark text-center text-md font-semibold">NAMA GURU
                                        </h5>
                                        <p class="text-slate-500 text-center text-sm font-light mt-2">nama mata
                                            pelajaran</p>
                                    </div>
                                </div>
                            </div>
                ...
                {{-- ===== ACCORDION 3: Tenaga Kependidikan ===== --}}
                <div role="accordion">
                    <button type="button"
                        class="accordion-button cursor-pointer w-full text-md font-bold text-left py-3 px-6 hover:bg-gray-100 text-slate-900 flex items-center transition-all border-2 rounded-4xl">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-2 mt-3 px-6">
                            <div>
                                <div
                                    ...
                                    <div class="p-2">
                                        <h5 class="text-matauli-red-dark text-center text-md font-semibold">NAMA</h5>
                                        <p class="text-slate-500 text-center text-sm font-light mt-2">jabatan</p>
                                    </div>
                                </div>
                            </div>
                        </div>
