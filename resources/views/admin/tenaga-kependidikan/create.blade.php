...
@section('content')
    <div class="max-w-4xl">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 md:p-8">
            <h2 class="text-lg font-bold text-gray-900 mb-6">Tambah Tenaga Kependidikan</h2>
            @if ($errors->any())
            ...
            @endif
            <form action="{{ route('admin.tenaga-kependidikan.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                @csrf
                <div>
                ...
                <div data-lang-tabs>
                    ...
                    <div data-tab-pane="id">
                        ...
                        <input type="text" name="jabatan[id]" value="{{ old('jabatan.id') }}" required class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-red-800 focus:border-transparent transition" />
                    </div>
                    <div data-tab-pane="en" class="hidden">
                        ...
                        <input type="text" name="jabatan[en]" value="{{ old('jabatan.en') }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-red-800 focus:border-transparent transition" />
                    </div>
                </div>
                <div>
