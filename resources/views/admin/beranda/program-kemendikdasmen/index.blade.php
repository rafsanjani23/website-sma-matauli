...
@section('title', 'Beranda - Program Kemendikdasmen')

@section('content')
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-bold text-gray-900">Beranda - Program Kemendikdasmen</h2>
        </div>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    @forelse ($items as $item)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('admin.beranda.program-kemendikdasmen.edit', array_merge(['id' => $item->id], request()->query())) }}"
