...
<body class="bg-gray-100 min-h-screen">
    ...
    <div id="confirm-modal" class="fixed inset-0 z-[9998] hidden">
        ...
        <div class="relative flex items-center justify-center min-h-screen p-4">
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden animate-[scaleIn_0.2s_ease-out]">
                ...
                <div class="flex border-t border-gray-200">
                    <button type="button" id="confirm-cancel" class="flex-1 px-6 py-3.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 transition rounded-bl-2xl">Batal</button>
                    <button type="button" id="confirm-ok" class="flex-1 px-6 py-3.5 text-sm font-semibold border-l border-gray-200 transition rounded-br-2xl"></button>
                </div>
            </div>
        </div>
    </div>
    ...
    (function() {
        ...
        function showConfirm(type, form) {
            ...
            pendingForm = form;
            iconEl.className = 'mx-auto w-16 h-16 rounded-full flex items-center justify-center mb-4 ' + config.iconBg;
            iconEl.innerHTML = config.icon;
            titleEl.textContent = config.title;
            messageEl.textContent = config.message;
            okBtn.textContent = config.okText;
            okBtn.className = 'flex-1 px-6 py-3.5 text-sm font-semibold border-l border-gray-200 transition rounded-br-2xl ' + config.okClass;
