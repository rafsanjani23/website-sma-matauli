...
@section('title', 'Edit Program Kemendikdasmen')
...
@section('content')
    <div class="max-w-4xl">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 md:p-8">
            <h2 class="text-lg font-bold text-gray-900 mb-6">Edit Program Kemendikdasmen</h2>
            ...
            <form action="{{ route('admin.program-kemendikdasmen.update', array_merge(['id' => $item->id], request()->query())) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                @csrf
                @method('PUT')
