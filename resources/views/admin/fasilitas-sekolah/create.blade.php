...
@section('content')
    <div class="max-w-4xl">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 md:p-8">
            <h2 class="text-lg font-bold text-gray-900 mb-6">Tambah Fasilitas Sekolah</h2>
            ...
            <form action="{{ route('admin.fasilitas-sekolah.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                @csrf
                ...
                <div data-lang-tabs>
                    ...
                    <div data-tab-pane="id">
                        ...
                        <input type="text" name="nama[id]" value="{{ old('nama.id') }}" required
                    ...
                    <div data-tab-pane="en" class="hidden">
                        ...
                        <input type="text" name="nama[en]" value="{{ old('nama.en') }}"
                            class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-red-800 focus:border-transparent transition">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <select name="kategori" id="kategori" required
                        ...
                        <option value="Laboratorium / Studi" {{ old('kategori') == 'Laboratorium / Studi' ? 'selected' : '' }}>Laboratorium / Studi</option>
                        <option value="Fasilitas Akademik" {{ old('kategori') == 'Fasilitas Akademik' ? 'selected' : '' }}>Fasilitas Akademik</option>
