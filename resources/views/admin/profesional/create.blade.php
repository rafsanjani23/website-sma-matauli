...
@section('content')
    <div class="max-w-4xl">
        <div class="mb-6">
            <a href="{{ route('admin.profesional.index', request()->query()) }}" class="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-red-800 transition">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 md:p-8">
            <h2 class="text-lg font-bold text-gray-900 mb-6">Tambah Profesional</h2>
            @if ($errors->any())
            ...
            @endif
            <form action="{{ route('admin.profesional.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                @csrf
                <div>
                ...
                <div data-lang-tabs>
                    ...
                    <div data-tab-pane="id">
                        ...
                        <input type="text" name="nama_lembaga[id]" value="{{ old('nama_lembaga.id') }}" required class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-red-800 focus:border-transparent transition" />
                    </div>
                    <div data-tab-pane="en" class="hidden">
                        ...
                        <input type="text" name="nama_lembaga[en]" value="{{ old('nama_lembaga.en') }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-red-800 focus:border-transparent transition" />
                    </div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="link_facebook" id="link_facebook" value="{{ old('link_facebook') }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-red-800 focus:border-transparent transition" />
                </div>
                <div>
                    <label for="link_twitter" class="block text-sm font-semibold text-gray-700 mb-1.5">Link Twitter</label>
                    <input type="text" name="link_twitter" id="link_twitter" value="{{ old('link_twitter') }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-red-800 focus:border-transparent transition" />
                </div>
                <div>
                    <label for="link_linkedin" class="block text-sm font-semibold text-gray-700 mb-1.5">Link LinkedIn</label>
                    <input type="text" name="link_linkedin" id="link_linkedin" value="{{ old('link_linkedin') }}" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-red-800 focus:border-transparent transition" />
                </div>
                <div class="pt-4">
