...
@section('content')
    <div class="max-w-4xl">
        <div class="mb-6">
            <a href="{{ route('admin.prestasi.index', request()->query()) }}" class="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-red-800 transition">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 md:p-8">
            <h2 class="text-lg font-bold text-gray-900 mb-6">Tambah Prestasi</h2>
            ...
            <form action="{{ route('admin.prestasi.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                ...
                <div>
                    ...
                    <select name="kategori" id="kategori" required
                        ...
                        <option value="Prestasi Sekolah" {{ old('kategori') == 'Prestasi Sekolah' ? 'selected' : '' }}>Prestasi Sekolah</option>
                        <option value="Prestasi Siswa" {{ old('kategori') == 'Prestasi Siswa' ? 'selected' : '' }}>Prestasi Siswa</option>
                        <option value="Prestasi Guru" {{ old('kategori') == 'Prestasi Guru' ? 'selected' : '' }}>Prestasi Guru</option>
                    </select>
                </div>
