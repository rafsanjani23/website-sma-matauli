        ...
        <div class="relative mx-auto px-4 sm:px-6 md:px-12 lg:px-24 xl:px-32">
            ...
            <div class="text-center flex flex-col mb-16 md:mb-18">
                <div class="relative mx-auto">
                    <img src="{{ asset('assets/Logo_SMAN_Matauli.webp') }}" alt="Program IB" class="h-28 w-full">
                </div>
                <div>
                    <h2 class="mt-2 text-3xl md:text-4xl lg:text-5xl font-bold text-black">{{ __('Program IB') }}</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 max-w-6xl mx-auto items-stretch">
                @forelse ($items as $item)
                    <a href="{{ route('program-ib-detail', $item->id) }}" class="group block h-full">
                        <div
                            ...
                            <div class="p-6 md:p-8 flex flex-col flex-1">
                                <h3
                                    class="text-xl md:text-2xl font-bold text-gray-900 mb-3 group-hover:text-red-800 transition-colors duration-300 leading-snug text-center">
                                    {{ $item->judul }}
                                </h3>
                ...
                @empty
                    <div class="col-span-full text-center py-12">
                        <p class="text-gray-400 text-sm">{{ __('Belum ada data program IB.') }}</p>
                    </div>
                @endforelse
            </div>
        </div>
